...
url = "https://ultrashop.uz/ru/store/komplektuyushie"
...
for product in main_block:
    ...
    complects_Base.append({
        "Complects_name": product_name,
        "Complects_price": product_price,
        "Complects_image": product_image
    })

print(complects_Base)